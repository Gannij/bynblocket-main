//använder sig av formidable som läser av binär data. installera npm install formidable//
const formidable = require('formidable')
const fs = require('fs') //fs står för file system//
const path = require("path");

module.exports = function(app){

// endpoint to handle formData uploads, request till api upload och letar upp fil som tex fältet file.
